...
\alias{print.mcsSubset2}
\alias{plot.mcsSubset2}
...
\method{mcsSubset}{lm}(object, model.return = TRUE, x.return = FALSE,
y.return = FALSE, \dots)

\method{mcsSubset}{formula}(formula, data, row.subset, weights,
na.action = na.omit, model.return = TRUE, x.return = FALSE,
y.return = FALSE, contrasts = NULL, offset, \ldots)

\method{mcsSubset}{default}(object, y, weights = NULL, offset = NULL,
...
\value{
  An object of class \code{"mcsSubset"} or \code{"mcsSubset2"}, i.e. a list
  ...
  For objects of class \code{"mcsSubset"}:
  ...
  For objects of class \code{"mcsSubset2"}:
