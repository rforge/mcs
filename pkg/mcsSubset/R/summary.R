...
summary.mcsSubset <- function (object, penalty = 2, ...) {
  ...
  ## class
  class(object) <- c("summary.mcsSubset", "mcsSubset2", "mcsSubset0")
...
## summary for 'mcsSubset2' objects
##
## Args:
##   object  - (mcsSubset2)
##   penalty - (numeric)
##   ...     - ignored
##
## Rval:  (summary.mcsSubset2)
##
## Do nothing for objects of type 'mcsSubset2'.
##
summary.mcsSubset2 <- function (object, penalty = NULL,...) {
  paste <- function (..., sep = "") base::paste(..., sep = sep)
