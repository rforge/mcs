...
%--------------------------------------------------------------------%
%
%% \VignetteIndexEntry{lmSubsets: Efficient Computation of Best-Subset
%%   Linear Regressions in R}
%% \VignetteKeywords{linear regression, model selection, variable
%%   selection, best-subset regression, R}
