...
if (is.null(bm)) {
    ...
    ## ===================================================
    ##     1-5 |   25 |   20 |    10 |     1-5 |       yes
    ## ---------------------------------------------------
    ##    6-10 |   50 |   40 |    20 |     1-5 |       yes
    ## ---------------------------------------------------
    ##   11-15 |   75 |   60 |    30 |     1-5 |       yes
    ## ---------------------------------------------------
    ##   16-20 |  100 |   80 |    40 |     1-5 |       yes
    ##
    bm <- data_benchmark(bm, NOBS = 25, NVAR = 20, NTRUE = 10, DIST_ID = 1:5)
    bm <- data_benchmark(bm, NOBS = 50, NVAR = 40, NTRUE = 20, DIST_ID = 1:5)
    bm <- data_benchmark(bm, NOBS = 75, NVAR = 60, NTRUE = 30, DIST_ID = 1:5)
    bm <- data_benchmark(bm, NOBS = 100, NVAR = 80, NTRUE = 40, DIST_ID = 1:5)
