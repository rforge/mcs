...
namespace detail {
  ...
  >
  TReal
  DcaState<TReal>::minBound(const int size, const TCrit<TReal>& c) const
  {
  ...
  >
  void
  DcaState<TReal>::reportSubleading(DcaTable<TReal, TCrit>& table) const
  {
    const Node* const cur = currentNode_;
